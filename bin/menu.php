...
<ul id="nav-mobile" class="side-nav fixed">
    <li class="logo">
        <a id="logo-container" href="<?php echo GLOBALPATH; ?>/pages/buscar/por_nombre.php" class="brand-logo">
    ...
    <ul class="collapsible collapsible-accordion">
        ...
        menuElement(GLOBALPATH . '/pages/iamsa/etn_ars_resumen.php', '', 'Reporte de viajes ETN/ARS', (activePageDir() == GLOBALPATH . "/pages/iamsa" ? "active" : ""));
        menuElement(GLOBALPATH . '/pages/iamsa/viva_aerobus_resumen.php', '', 'Reporte de viajes VIVA AEROBUS', (activePageDir() == GLOBALPATH . "/pages/iamsa" ? "active" : ""));
        menu_seccion_fin();
        echo '<div class="divider"> &nbsp; </div>';
