		...
		<footer class="page-footer">
			...
			<div class="footer-copyright">
				<div class="container">
					...
					por <a class="white-text" target="new" xmlns:cc="<?php echo LICENSEURL; ?>/ns#" href="<?php echo AUTHORURL; ?>" property="cc:attributionName" rel="cc:attributionURL"> <i class="i-cyzzaro prefix"></i> Cyzzaro</a> 
