...
function formToSearchByName($string_to_search)
{
	...
	if (isset($_GET['nombre_afiliado']))
	{
		...
		$query = "
			SELECT 
				clafiltmk, nombre_afiliado, fecha_venta, dni, identificador, estatus, fecha_estatus, ultimo_procesado, fecha_ultimo_procesado, fecha_ultimo_exitoso, acumulado_exitosos, nombre_agente  
