<?php
	...
	if ($query_criteria_filter == '') {
		...
		$query_criteria_filter_en_bd = " WHERE origen IS NOT NULL";
		
	} else {
		
		$query_criteria_filter_en_bd = " WHERE origen LIKE '%".$query_criteria_filter."%'";
	...
	$string_to_search = "SELECT identificador FROM afiliados".$query_criteria_filter_en_bd.$query_date_filterFilter;
